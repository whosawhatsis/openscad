...
material("red", finish = [2, 0.5]) cube(10);

// 2. material() with an explicit seed
material("red", finish = [2, 0.5, 7]) cube(10);
...
material("red", finish = 2) cube(10);
material("red", finish = [2, 1, 0]) cube(10);

// 5. omitted seed is exactly equivalent to seed = 0
material("green", finish = [3, 1]) cube(10);
material("green", finish = [3, 1, 0]) cube(10);

// --- scalar PBR ---

// 6. roughness alone
material("red", roughness = 0.4) cube(10);

// 7. metallic alone
material("red", metallic = 1) cube(10);

// 8. the metallic-roughness pair, which is how PBR is normally written
material("red", roughness = 0.2, metallic = 0.9) cube(10);
...
material("red", finish = [2, 0.5], roughness = 0.3, metallic = 0) cube(10);
